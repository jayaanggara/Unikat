            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-md-11">
                        ...
                        <p>We want to make sure you have the best experience possible. If you decide to cancel before you
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                <div class="col-md-6">
                    ...
                    <div class="row align-items-center border-top border-bottom py-3">
                ...
                <div class="col-md-6">
                    <img src="{{ asset('assets/images/about/speda.png') }}" alt="">
                </div>
            </div>
        </div>
    </section>
